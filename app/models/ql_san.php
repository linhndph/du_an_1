...
function insert_ca2($id_ca,$id_san){
    $sql = "INSERT INTO tb_trang_thai_ca(id_trang_thai,id_ca,id_san) VALUES (1,'$id_ca','$id_san')";
    pdo_execute($sql);
}
...
function insert_san($ten_bien_the,$ten_danh_muc,$ten_san,$img_san)
{
    ...
    foreach ($listdatsan as $value) {
        ...
        // break;
        $listca = loadAllCASAN();
        foreach($listca as $value1){
           
            insert_ca2($value1['id_ca'],$value['id_san']);
        }
        break;
