...
if (isset($_GET['act']) && ($_GET['act']!= "")) {
    ...
    switch ($act) {
        ...
        case 'xacnhandatsan':
            ...
            if(isset($_GET['id_ctdatsan']) && $_GET['id_ctdatsan']>0){
                $id_ctdatsan= $_GET['id_ctdatsan'];
                $trang_thaihd="Đã xác nhận";
                update_datsan($id_ctdatsan,$trang_thaihd);
                $id_ca=$_GET["id_ca"];
                $id_san=$_GET["id_san"];
                $id_trang_thai=2;
