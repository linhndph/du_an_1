                                ...
                                <form method="post" action="ClientController.php?act=themdondatsan" enctype="multipart/form-data">
                                    <div class="row align-items-center">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <?php 
                                                        ...
                                                        echo '
                                                        <input type="date" name="ngay_da" class="form-control" style="padding-top:10px;" required min="'.$ngayHomNay.'">
                                                        ';
                                                    ?>
                                        ...
                                        <div class="form-group">
                                            <label>Ca Sân</label>
                                            <div class="input-group">
                                           <select class="form-control" name="casan" id="caSan" onchange="chonCaSan()">
                                          <?php 
                                       

                                        $dem = 0;
                                          foreach ($list_tt as $casan){
                                            if ($casan['id']==1) {
                                                $dem = 1;
                                          ?>
                                          
                                            <option value="<?php echo $casan['ten_ca'] ?>"><?php echo $casan['ten_ca'];
                                            $lst=loadOneCASAN($casan['id_ca']);
                                                extract($lst);
                                                echo" : ";
                                                echo $thoi_gian_bd;
                                                echo"  -  ";
                                    ...
                                    ?> <option value="NULL">Hết ca rồi</option>
                                    <?php
}?>
                                           </select>
                                        ...
                                        if (isset($_SESSION['ten_dang_nhap'])) {
                                            ...
                                            <input type="submit" class="default-btn btn-bg-three border-radius-5" name="booknow" value="Đặt ngay">
                                ...
                                echo ' <div class="room-details-review">
                                        ...
                                        <div class="review-ratting">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 col-md-12">
                                                    <input type="submit" class="default-btn btn-bg-three" value="Gửi bình luận"
                                                        name="binhluan">
